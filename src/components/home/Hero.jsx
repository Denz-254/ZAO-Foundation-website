        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl xl:text-6xl font-bold leading-tight text-[#0B2C6B]">
              Together, We Can
              <br />
              Create <span className="text-[#C8102E]">Lasting Change.</span>
            </h1>
          ...
          >
            {/* Soft glow */}
            <div className="absolute w-[340px] h-[340px] bg-[#C8102E]/10 blur-3xl rounded-full" />

            {/* Decorative gradient circle */}
            <div className="absolute bottom-8 w-[320px] h-[320px] rounded-full bg-gradient-to-br from-[#C8102E]/10 to-[#0B2C6B]/10" />

            {/* Transparent PNG */}
            <img
              src="/hero.png"
              alt="Zilpah Atieno Odak"
              className="
                relative
                z-10
                w-[320px]
        ...
        <div className="mt-14 pt-8 border-t border-gray-100">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col items-center">
              ...
              <h4 className="font-bold text-[#0B2C6B] text-sm">
                Sustainable
              </h4>
